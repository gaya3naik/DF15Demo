    ...
    public List<Map<String, Object>> fetchData(Request request){
        ...
        try {
            ...
            if("MD".equalsIgnoreCase(analysisType)){
                ...
                String query = "SELECT Id,Name,PageViews__c,Revenue__c,SessionCount__c,Date__c FROM EmployeeInfo__c";
                ...
                String query = "SELECT Date__c,ReopenCount__c,ResolutionTime__c FROM CaseAnalytics__c";
